...
from modules.config import DATA_DIR, GC_AREA_CM2, NU_CMS2, N_ELECTRONS
from modules.diffusion import get_calculated_diffusion
from modules.io_utils import read_biologic_table, write_csv
from modules.plotting import beautify_axes, safe_save
from modules.task32_eis import _extract_eis_parameters_both
...
def run_task33_lsv_eis(config: AnalysisConfig) -> TaskReport:
    report = TaskReport(name="Task 3.3 - LSV/EIS")
    lsv_dir = config.data_dir / "Task 3.3 LSV"
